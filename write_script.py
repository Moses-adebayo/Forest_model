...
<ParameterList name="Main" type="ParameterList">
    ...
    <ParameterList name="regions" type="ParameterList">
      ...
      <ParameterList name="surface right" type="ParameterList">
        <ParameterList name="region: box" type="ParameterList">
          <Parameter name="low coordinate" type="Array(double)" value="{104.0, -0.5}"/>
          <Parameter name="high coordinate" type="Array(double)" value="{104.0, 0.5}"/>
        </ParameterList>
      </ParameterList>
      ...
      <ParameterList name="right_face" type="ParameterList">
        <ParameterList name="region: plane" type="ParameterList">
          <Parameter name="point" type="Array(double)" value="{104.0, 0.0, 0.0}"/>
          <Parameter name="normal" type="Array(double)" value="{1.0, 0.0, 0.0}"/>
        </ParameterList>
      </ParameterList>
            ...
            <ParameterList name="BC right" type="ParameterList">
              ...
              <ParameterList name="boundary head" type="ParameterList">
                <ParameterList name="function-tabular" type="ParameterList">
                  <Parameter name="file" type="string" value="../data/Site_1_Water_level_hourly.h5"/>
      ...
      <ParameterList name="overland_flow" type="ParameterList">
        ...
        <ParameterList name="boundary conditions">
  		...
  		<ParameterList name="seepage face head">
  			<ParameterList name="surface left">
      ...
      <ParameterList name="evaluators" type="ParameterList">
        ...
        <ParameterList name="surface-incident_shortwave_radiation" type="ParameterList">
          ...
          <ParameterList name="incident shortwave radiation parameters" type="ParameterList">
            ...
            <Parameter name="latitude [degrees]" type="double" value="35.0"/>
          </ParameterList>
        </ParameterList>
        <ParameterList name="surface-incoming_shortwave_radiation" type="ParameterList">
          ...
          <ParameterList name="function" type="ParameterList">
            <ParameterList name="domain" type="ParameterList">
              ...
              <ParameterList name="function" type="ParameterList">
                <ParameterList name="function-tabular" type="ParameterList">
                  <Parameter name="file" type="string" value="../data/forested_daymet_data_hourly.h5"/>
                  <Parameter name="x header" type="string" value="time [s]"/>
    ...
    <ParameterList name="observations" type="ParameterList">
      <ParameterList name="fluxes" type="ParameterList">
        ...
        '''
    with open('Site1_param'+str(i)+'.xml', 'w') as f:
        f.write(block1)
...
<ParameterList name="Main" type="ParameterList">
  <ParameterList name="mesh" type="ParameterList">
    ...
    <ParameterList name="domain" type="ParameterList">
      ...
      <Parameter name="build columns from set" type="string" value="surface"/>
      <ParameterList name="read mesh file parameters" type="ParameterList">
        <Parameter name="file" type="string" value="../data/Site_2.exo"/>
        <Parameter name="format" type="string" value="Exodus II"/>
      </ParameterList>
    </ParameterList>
  </ParameterList>
  ...
  <ParameterList name="regions" type="ParameterList">
    ...
    <ParameterList name="surface right" type="ParameterList">
      <ParameterList name="region: box" type="ParameterList">
        <Parameter name="low coordinate" type="Array(double)" value="{149.5, -0.5}"/>
        <Parameter name="high coordinate" type="Array(double)" value="{149.5, 0.5}"/>
      </ParameterList>
    </ParameterList>
    <ParameterList name="surface boundary" type="ParameterList">
      <ParameterList name="region: plane" type="ParameterList">
    ...
    <ParameterList name="right_face" type="ParameterList">
      <ParameterList name="region: plane" type="ParameterList">
        <Parameter name="point" type="Array(double)" value="{149.5, 0.0, 0.0}"/>
        <Parameter name="normal" type="Array(double)" value="{1.0, 0.0, 0.0}"/>
      </ParameterList>
    </ParameterList>
    <ParameterList name="GLHYMPS_100" type="ParameterList">
  ...
  <ParameterList name="cycle driver" type="ParameterList">
    <Parameter name="start time" type="double" value="334.0"/>
    <Parameter name="start time units" type="string" value="d"/>
      ...
      <ParameterList name="boundary conditions" type="ParameterList">
        <ParameterList name="fixed level" type="ParameterList">
          <ParameterList name="BC left" type="ParameterList">
            ...
            <ParameterList name="fixed level" type="ParameterList">
              <ParameterList name="function-tabular" type="ParameterList">
                <Parameter name="file" type="string" value="../data/Site_2_GW_level_hourly.h5"/>
                <Parameter name="x header" type="string" value="time [s]"/>
                <Parameter name="y header" type="string" value="Water_level [m]"/>
                <Parameter name="form" type="Array(string)" value="{linear}"/>
              </ParameterList>
      ...
      <ParameterList name="boundary conditions">
        <ParameterList name="head" type="ParameterList">
          <ParameterList name="surface left" type="ParameterList">
            ...
            <ParameterList name="boundary head" type="ParameterList">
              <ParameterList name="function-tabular" type="ParameterList">
                <Parameter name="file" type="string" value="../data/Site_2_Water_level_hourly.h5"/>
                <Parameter name="x header" type="string" value="time [s]"/>
                <Parameter name="y header" type="string" value="Water_level [m]"/>
                <Parameter name="form" type="Array(string)" value="{linear}"/>
              </ParameterList>
  ...
  <ParameterList name="observations" type="ParameterList">
    <ParameterList name="fluxes" type="ParameterList">
      ...
      <ParameterList name="observed quantities" type="ParameterList">
        ...
        '''
    with open('Site2_param'+str(i)+'.xml', 'w') as f:
        f.write(block1)
        f.write(block2.format(perm1, perm2))
        f.write(block3)   